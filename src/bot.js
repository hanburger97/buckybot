...
const MessageObserver = require('src/api/messaging/observers/message.observer.js');
const PostbackObserver = require('src/api/messaging/observers/postback.observer.js');
const QuickReplyObserver = require('src/api/messaging/observers/quick.reply.observer.js');
